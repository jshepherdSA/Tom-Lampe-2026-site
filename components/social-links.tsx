...
/** Marks are drawn inline; slot order matches content/copy.ts `social`. */
const marks = [
  ...
  "M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.65l-5.22-6.82-5.96 6.82H1.67l7.73-8.84L1.25 2.25h6.82l4.71 6.23zm-1.16 17.52h1.83L7.08 4.13H5.11z",
];
